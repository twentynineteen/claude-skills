---
name: ui-analyzer
description: Analyze and improve visual consistency, text hierarchy, and WCAG 2.1 Level AA accessibility of React/TypeScript UI components. Audits all TSX files, creates reports, and automatically applies fixes.
---
